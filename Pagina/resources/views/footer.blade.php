        ...
        <div class="footer_row row">
            ...
            <div class="col-md-3 col-sm-6 footer_about quick">
                ...
                <ul class="quick_link">
                    ...
                    <li><a href="#"><i class="fa fa-chevron-right"></i>Sobre Nosotros</a></li>
                    <li><a href="#"><i class="fa fa-chevron-right"></i>Servicios</a></li>
                    <li><a href="#"><i class="fa fa-chevron-right"></i>Galería</a></li>
                    <li><a href="#"><i class="fa fa-chevron-right"></i>Blog</a></li>
                    <li><a href="#"><i class="fa fa-chevron-right"></i>Contactos</a></li>
                </ul>
            </div>
            <div class="col-md-3 col-sm-6 footer_about">
                <h2>Redes socales</h2>
            ...
            <div class="col-md-3 col-sm-6 footer_about">
                ...
                <address>
                    ...
                    <ul class="my_address">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>info@dte-ecuador.org</a></li>
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>099 338 4378</a></li>
