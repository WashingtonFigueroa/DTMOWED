                                ...
                                <div id="grid">
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "blue", "square"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Facturación Electrónica PYMES / ENTERPRISE</h5>
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "green", "square"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Facturación Electrónica Restaurantes / Bares</h5>
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "letters", "blue", "square"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Alojamiento Comprobantes Electrónicos </h5>
                                            ...
                                            <div class="portfolio-links">
                                                ...
                                                <a href="http://alojamientonova.coatlfact.com/" target="_blank"><i class="fa fa-link"></i></a>
                                            </div><!-- /.links -->
                                        </div><!-- /.single-portfolio -->
                                    </div><!-- /.portfolio-item -->
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "red", "square"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Digitalización y Seguimiento de Archivos </h5>
                                            ...
                                            <div class="portfolio-links">
                                                ...
                                                <a href="http://filetracking.dte-ecuador.org/login" target="_blank"><i class="fa fa-link"></i></a>
                                            </div><!-- /.links -->
                                        </div><!-- /.single-portfolio -->
                                    </div><!-- /.portfolio-item -->
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "red", "circle"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Administracion Junta de Aguas </h5>
                                            ...
                                            <div class="portfolio-links">
                                                ...
                                                <a href="http://jaap.dte-ecuador.org/" target="_blank"><i class="fa fa-link"></i></a>
                                            </div><!-- /.links -->
                                        </div><!-- /.single-portfolio -->
                                    </div><!-- /.portfolio-item -->
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "red", "square"]'>
                                        <div class="single-portfolio">
                                            ...
                                            <div class="portfolio-links">
                                                ...
                                                <a href="http://rueda.francomamani.com/#/auth" target="_blank"><i class="fa fa-link"></i></a>
                                            </div><!-- /.links -->
                                        </div><!-- /.single-portfolio -->
                                    </div><!-- /.portfolio-item -->
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "green", "square"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Administración envio de encomiendas </h5>
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "letters", "green", "circle"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Administración Parqueo tarifado</h5>
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "blue", "square"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Administración de Odontología </h5>
                                    ...
                                    <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "letters", "red", "square"]'>
                                        <div class="single-portfolio">
                                            <br>
                                            <h5>Administración Citas Médicas </h5>
